...
/// The end-to-end latency of the live stream.
...
/// All qualities available for the media stream.
...
/// Begins or resumes playback. If `state` is already `IVSPlayerStateReady`, playback starts immediately.
- (void)play;

/// Sets the playback time to the specified value.
...
- (void)setAutoMaxQuality:(IVSQuality *)quality;
